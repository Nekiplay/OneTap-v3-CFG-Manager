...
function user() {
    ...
    if (!UI.GetValue(["Rage", "Anti-Aim.js", "Anti-Aim.js", "Seizure Watermark"]) && !UI.GetValue(["Rage", "Anti-Aim.js", "Anti-Aim.js", "RBG Fade Watermark"])) {
        Render.String( ( Global.GetScreenSize()[0] / 20) + wm_xOffset, Global.GetScreenSize()[1] + wm_yOffset, 1, "11111", [0, 255, 255, 255], font);
        ...
        Render.String(Global.GetScreenSize()[0] / 20 + wm_xOffset, Global.GetScreenSize()[1] + wm_yOffset, 1, "11111", [rgb_r, rgb_g, rgb_b, 255], font);
    } else {
        Render.String( (Global.GetScreenSize()[0] / 20 + wm_xOffset),  (Global.GetScreenSize()[1] + wm_yOffset), 1, "11111", [rand_int( 0, 255), rand_int(0, 255), rand_int(0, 255), 255], font);
    }
    return true;
}
